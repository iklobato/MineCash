...
- [Component Deep Dive](#component-deep-dive)
  - [VPC Module](#vpc-module-modulesvpcc)
  - [Storage Module](#storage-module-modulesstoragec)
  - [Cache Module](#cache-module-modulescachec)
  - [Networking Module](#networking-module-modulesnetworkingc)
  - [ECS Module](#ecs-module-modulesecsc)
  - [Route 53 DNS Module](#route-53-dns-module-modulesroute53-dnsc)
  - [Root Module](#root-module-maintf)
- [Data Flow and Network Architecture](#data-flow-and-network-architecture)
  - [Player Connection Flow](#player-connection-flow)
  - [Container Storage Access Flow](#container-storage-access-flow)
  - [Cache Access Flow](#cache-access-flow)
  - [Administrative Access Flow](#administrative-access-flow)
  - [Outbound Internet Flow](#outbound-internet-flow)
  - [Network Isolation Boundaries](#network-isolation-boundaries)
  - [Security Group Interaction Diagram](#security-group-interaction-diagram)
- [Module Organization](#module-organization)
  - [Module Design Principles](#module-design-principles)
  - [Module Responsibilities and Boundaries](#module-responsibilities-and-boundaries)
  - [Module Dependencies and Execution Order](#module-dependencies-and-execution-order)
  - [Module Interface (Inputs/Outputs)](#module-interface-inputsoutputs)
  - [Module Reusability](#module-reusability)
- [Variables](#variables)
  - [Variable Categories](#variable-categories)
  - [Variable Validation Rules Explained](#variable-validation-rules-explained)
  - [Default Values Rationale](#default-values-rationale)
  - [Configuration Examples for Different Scenarios](#configuration-examples-for-different-scenarios)
  - [Environment-Specific Configurations](#environment-specific-configurations)
  - [Secrets Management Workflow](#secrets-management-workflow)
  - [Backend Configuration (S3/DynamoDB)](#backend-configuration-s3dynamodb)
...
- [Minecraft Server Configuration](#minecraft-server-configuration)
  ...
  - [Currently Configured Parameters](#currently-configured-parameters)
  - [Environment Variables Reference](#environment-variables-reference)
  - [server.properties File Configuration](#serverproperties-file-configuration)
  - [JVM Options Configuration](#jvm-options-configuration)
...
- [Outputs](#outputs)
- [Scaling](#scaling)
  - [Horizontal Scaling (Adding More Containers)](#horizontal-scaling-adding-more-containers)
  - [Vertical Scaling (Increasing Container Resources)](#vertical-scaling-increasing-container-resources)
  - [Storage Scaling](#storage-scaling)
  - [Redis Scaling](#redis-scaling)
- [Updating Container Image](#updating-container-image)
- [Accessing Containers](#accessing-containers)
- [Cleanup](#cleanup)
  - [Backup Before Destruction](#backup-before-destruction)
...
- [Contribution Guidelines](#contribution-guidelines)
  ...
  - [Terraform Best Practices Followed](#terraform-best-practices-followed)
